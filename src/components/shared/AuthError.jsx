  ...
  return (
    <div style={{ display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',minHeight:'100dvh',padding:24,textAlign:'center',background:'var(--bg)',gap:20 }}>
      ...
      <div style={{ color:'var(--tx2)',lineHeight:1.8,maxWidth:280,fontSize:13 }}>
        {isNotReg?'برای استفاده از Mini App هامزیار باید ابتدا در ربات تلگرام ثبت‌نام کنید.':
      ...
      {isNotReg && <div style={{ background:'var(--acc-soft)',border:'1px solid var(--bdg)',borderRadius:'var(--r-lg)',padding:14,maxWidth:280,width:'100%',fontSize:13,color:'var(--tx2)',lineHeight:1.7 }}>👈 ربات هامزیار را پیدا کن و /start بزن</div>}
    </div>
  );
}
